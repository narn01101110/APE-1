...
_AXES = ['X', 'Y', 'Z', 'R', 'I', 'J']
_Z_AXES = ['Z']
# You may need to update these to get the right index for the Mega
_AXIS_INDEX = {'X': 0, 'Y': 1, 'U': 2, 'Z': 3}
_DEFAULT_RAPID_SPEED = {'Y': 50, 'X': 50, 'Z': 20}
_NUM_TASKS = 4
...
class A3200:
    def __init__(self, handle=None, default_task=1, debug=False):
        if handle is None:
            ...
            # Get the library
            # Check that this is the correct location of the Aerotech DLL
